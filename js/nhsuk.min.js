!function (n) {
    ...
    function o() {
        ...
        }), t = document.querySelector("#toggle-menu"), e = document.querySelector("#toggle-menu"), n = document.querySelector("#header-navigation"), r = function (e) {
    ...
    function i() {
        var o = "boolean" == typeof document.createElement("details").open, e = document.querySelectorAll("details.nhsuk-details");
