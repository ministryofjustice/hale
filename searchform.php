...
?>
<button class="jotw-header__mobile-controls jotw-header__mobile-controls--search govuk-js-header-toggle" <?php echo esc_attr( $toggle_search ); ?> aria-controls="search" aria-label="Open search" aria-expanded="false">
...
<div class="jotw-header__search-wrap" <?php echo esc_attr( $wrap_search ); ?>>
	<form class="jotw-header__search-form" <?php echo esc_attr( $search_form ); ?> action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get" role="search">
		...
		<input class="jotw-search__input govuk-input" id="<?php echo esc_attr( $search_field ); ?>" name="s" type="search" placeholder="<?php echo esc_attr__( 'Search', 'nightingale' ); ?>">
		<button class="jotw-search__submit govuk-button govuk-button--secondary" type="submit">
			<svg class="jotw-icon jotw-icon__search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
				<path d="M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z"></path>
			</svg>
			<span class="jotw-search__button-text"><?php esc_html_e( 'Search', 'nightingale' ); ?></span>
		</button>
	</form>
</div>
