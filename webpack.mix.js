...
mix_.setPublicPath('./dist')
  ...
  .scripts(['./assets/js/hale-scripts.js','./assets/js/skip-link-focus-fix.js','./assets/js/navigation.js','./assets/js/side-nav.js','./assets/js/banner-close-button.js'], 'dist/js/hale-combined-scripts.js')
