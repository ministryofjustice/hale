...
mix_.setPublicPath('./dist')
  ...
  .scripts(['./assets/js/hale-scripts.js','./assets/js/skip-link-focus-fix.js','./assets/js/navigation.js','./assets/js/banner-close-button.js', './node_modules/@ministryofjustice/frontend/moj/all.js', './node_modules/@ministryofjustice/frontend/moj/components/date-picker/date-picker.js'], 'dist/js/hale-combined-scripts.js')
