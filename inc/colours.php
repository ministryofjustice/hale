		...
		$colour_array = array(
			...
			[
				...
				"colours" => array(
					...
					['header-search-btn-border',$lightGrey,'Button border','',''],
					['header-search-input-focus-btn-border',$lightGrey,'Button border when search is focussed','',''],
					['header-search-btn-icon',$black,'Button icon','',''],
					['header-search-btn-hover-bg',$buttonHoverGrey,'Background on hover','',''],
					['header-search-btn-hover-border',$buttonHoverGrey,'Button border on hover','',''],
					['header-search-btn-hover-icon',$black,'Button icon on hover','',''],
					['header-search-btn-focus-bg',$yellow,'Button background when focussed','',''],
					['header-search-btn-focus-border',$yellow,'Button border when focussed','',''],
					['header-search-btn-focus-outline',"transparent",'Thick button outline when focussed','Leave blank for no thick line',''],
