		...
		$colour_array = array(
			...
			[
				...
				"colours" => array(
					...
					['header-link-current-border',$black,'Link, current page underline','',''],
					...
					['header-link-with-children-hover-border',"currentColor",'Link underline on hover','When there is secondary navigation (& when not on secondary navigation page)',''],
