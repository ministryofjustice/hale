	...
	function hale_get_colours() {
		...
		*/
		$colour_array = array(
			...
			['header-link-ancestor',$currentPageBlue,'Ancestor link','',''],
			...
			['header-submenu-link-current',$currentPageBlue,'Header current page','Main menu and submenu',''],
			['header-submenu-link-current-bg',$black,'Header current page background','Main menu and submenu',''],
			['header-submenu-link-current-hover-border',$currentPageBlue,'Header current page hover underline','',''],
