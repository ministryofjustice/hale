	...
	function hale_get_colours() {
		...
		*/
		$colour_array = array(
			...
			['header-link-border',"transparent",'Header link underline','Leave blank for no line',''],
			['header-link-highlight',$black,'Header link background','',''],
			['header-link-hover',$white,'Header link hover','Only links without children',''],
			['header-link-hover-highlight',$black,'Header link hover background','Only links without children',''],
			...
			['header-link-focus-highlight',$yellow,'Header link focus background','',''],
			['header-link-focus-underline',$black,'Header link focus underline','',''],
			['header-link-arrow',"currentColor",'Header link dropdown arrow','Desktop only, leave blank to match text colour',''],
			['header-link-arrow-hover',"currentColor",'Header link dropdown arrow hover','Desktop only, leave blank to match text colour',''],
			['header-link-arrow-focus',"currentColor",'Header link dropdown arrow focus','Desktop only, leave blank to match text colour',''],
			['header-link-arrow-current-page',"currentColor",'Header link dropdown arrow current page','Desktop only, leave blank to match text colour',''],
			...
			['header-divider-line',$headerMenuLineGrey,'Menu divider lines','Above main menu and mobile menu dividing lines',''],
			['header-divider-line-bottom',"transparent",'Menu divider line (bottom)','Beneath main menu, leave blank for no line',''],
