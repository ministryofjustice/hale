	...
	function hale_get_colours() {
		...
		*/
		$colour_array = array(
			...
			['header-link-current',$currentPageBlue,'Header current page','Unless page has submenu',''],
			['header-link-current-bg',$black,'Header current page background','Unless page has submenu',''],
			['header-link-current-hover-border',$currentPageBlue,'Header current page hover underline','Unless page has submenu',''],
			...
			['header-link-ancestor',$blue,'Ancestor link','Also for current page with Submenu',''],
			['header-link-ancestor-bg',$lightGrey,'Ancestor background','Also for current page with Submenu',''],
			['header-link-ancestor-hover-border',$blue,'Ancestor hover underline','Also for current page with Submenu',''],
			...
			['header-submenu-link-current',$blue,'Header current page','Main menu and submenu',''],
			['header-submenu-link-current-bg',$lightGrey,'Header current page background','Main menu and submenu',''],
			['header-submenu-link-current-hover-border',$blue,'Header current page hover underline','',''],
