	...
	function hale_get_colours() {
		...
		*/
		$colour_array = array(
			...
			['header-link-current',$blue,'Header current page','Main menu and submenu',''],
			['header-link-current-bg',$lightGrey,'Header current page background','Main menu and submenu',''],
			['header-link-current-hover-border',$blue,'Header current page hover underline','',''],
