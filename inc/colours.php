		...
		$colour_array = array(
			...
			[
				...
				"colours" => array(
					...
					['header-search-input-focus-bg',$white,'Background when focused','',''],
					['header-search-input-focus-border',$yellow,'Border when focused','',''],
					...
					['header-search-btn-focus-bg',$yellow,'Button background when focused','',''],
					['header-search-btn-focus-icon',$black,'Button icon when focused','',''],
				)
			],
			[
				...
				"colours" => array(
					...
					['header-link-hover-focus',$black,'Link text when focused, or on mouse click','',''],
					...
					['header-link-focus',$black,'Link text when focused','',''],
					['header-link-focus-highlight',$yellow,'Link background when focused','',''],
					['header-link-focus-underline',$black,'Link underline when focused','',''],
			...
			[
				...
				"colours" => array(
					...
					['button-focus-outline',$yellow,'Button outline when focused (including search button)','This is thicker than the button border',''],
				)
			],
			[
				...
				"colours" => array(
					...
					['quick-exit-button-focus-outline',$yellow,'Quick exit button outline when focused','This is thicker than the button border',''],
				)
			],
			[
				...
				"colours" => array(
					...
					['mojblocks-accordion-section-title-focus',$black,'Section titles when focused','',''],
					['mojblocks-accordion-section-shew-focus',$black,'Show/hide when focused','',''],
					['mojblocks-accordion-section-title-focus-bg',$yellow,'Section titles and show/hide background when focused','',''],
					['mojblocks-accordion-section-title-focus-shadow',$black,'Section titles and show/hide underline when focused','',''],
				)
			],
			[
