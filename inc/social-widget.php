...
class social_widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! empty( $instance['facebook_url'] ) ){
            echo '<a href="' . $instance['facebook_url']  . '"><span class="govuk-visually-hidden">Facebook</span><i class="facebook" aria-hidden="true"></i></a>';
        }

        if ( ! empty( $instance['instagram_url'] ) ){
            echo '<a href="' . $instance['instagram_url']  . '"><span class="govuk-visually-hidden">Instagram</span><i class="instagram" aria-hidden="true"></i></a>';
        }

        if ( ! empty( $instance['linkedin_url'] ) ){
            echo '<a href="' . $instance['linkedin_url']  . '"><span class="govuk-visually-hidden">Linkedin</span><i class="linkedin" aria-hidden="true"></i></a>';
        }

        if ( ! empty( $instance['twitter_url'] ) ){
            echo '<a href="' . $instance['twitter_url']  . '"><span class="govuk-visually-hidden">Twitter</span><i class="twitter" aria-hidden="true"></i></a>';
        }

        if ( ! empty( $instance['youtube_url'] ) ){
            echo '<a href="' . $instance['youtube_url']  . '"><span class="govuk-visually-hidden">YouTube</span><i class="youtube" aria-hidden="true"></i></a>';
        }
